...
def balance_sheet(request):
    ...
    all_cost_center_group = get_all_child_investments(Childs.objects.get(name="Current Assets"), cost_center=False, balance_sheet=True)
    all_cost_center_group.append("Current Assets")
    filtered_ledgers = Ledger.objects.filter(group_name__in=all_cost_center_group)
    for ledger in filtered_ledgers:
